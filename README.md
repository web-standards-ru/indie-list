# Список инди-сайтов по фронтенду
...
- [Ссылка на OPML-файл](/feeds.opml)
- [Ссылка на _плоский_ OPML-файл](/feeds.flat.opml): Содержит все ссылки, но все в одной "папке" (некоторые RSS-читалки не поддерживают вложенные `outline`)
- [Ссылка на русскоязыный OPML-файл](/feeds.ru.opml): Содержит только русскоязыные страницы
- [Ссылка на англоязычный OPML-файл](/feeds.en.opml): Содержит только англоязыные страницы
